	...
	return (
		<div className="flex justify-center items-center w-full flex-col py-4 min-h-screen bg-gray-200">
			<div className="p-8 flex flex-col items-center">
				...
				<div className="text-2xl leading-loose">Start your free trial</div>
				...
				<form onSubmit={handleSubmit} method="POST">
					<div className="mb-4 mt-2">
						...
						<input
							...
							id="username"
							name="name"
							className={`appearance-none border rounded w-full py-1 px-3 bg-gray-100 ${name.error
								? 'border-red-500'
								: ''}`}
							required
							autoFocus
					...
					<div className="mb-4">
						...
						<input
							...
							name="email"
							type="email"
							className={`appearance-none border rounded w-full py-1 px-3 bg-gray-100 ${email.error
								? 'border-red-500'
								: ''}`}
							required
							{...email.bind}
					...
					<div className="mb-4">
						...
						<input
							...
							id="password"
							name="password"
							className={`appearance-none border rounded w-full py-1 px-3 bg-gray-100  ${password.error
								? 'border-red-500'
								: ''}`}
							minLength={6}
							required
