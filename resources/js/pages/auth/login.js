				...
				<form onSubmit={handleSubmit} method="POST">
					<div className="mb-4 mt-4">
						...
						<input
							...
							type="email"
							name="email"
							className={`appearance-none border rounded w-full py-1 px-3 text-grey-darker bg-gray-100 ${email.error
								? 'border-red-500'
								: ''}`}
							required
							autoFocus
					...
					<div className="mb-3 flex justify-end">
						<Link to="/forgot-password" className="text-sm underline text-gray-600 font-bold">
							Forget password?
						</Link>
					</div>
